  ...
  <div class="private-message">
    <div class="message-list">
      ...
      <div class="private-Message-button">
        <buttonQuaternary @click="isMessageIconActive = !isMessageIconActive"></buttonQuaternary>
      </div>
    </div>
    <messageIcon v-show="isMessageIconActive"
                 @setMessageIconActive="isMessageIconActive = !isMessageIconActive"
                 @setTimer="setTimer"
                 @addMessage="addMessage"></messageIcon>
  </div>
</template>
