<template>
  <div class="quiz-home">
    <section class="quiz-card-content">
      ...
      <buttonTertiary
        @click="$emit('changeComponent', 'quizQuestionTwo')"
        :finishAnswerOne="finishAnswerOne"
      >{{finishAnswerOne?'正確':'作答'}}</buttonTertiary>
    </section>
    <section class="quiz-card-content">
      <h4>單選題</h4>
      <h5>第二題</h5>
      ...
      <buttonTertiary
        @click="$emit('changeComponent', 'quizQuestion')"
        :finishAnswerTwo="finishAnswerTwo"
      >{{finishAnswerTwo?'錯誤':'作答'}}</buttonTertiary>
    </section>
  </div>
</template>
