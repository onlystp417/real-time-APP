<template>
  <div class="rollcall-enroll">
    ...
    <div class="rollcall-button">
      <buttonQuinary @click="$emit('setTimer', {componentId: 'rollcallOntime', missionTimeData:{level:0,section:1,nextLevel: 0, nextSection: 2}})">我到了</buttonQuinary>
    </div>
  </div>
</template>
...
<style lang="scss">
  .rollcall {
    &-enroll {
      @include fontstyle(700, 40px, 1.2, $font, #727272);
      text-align: center;
      padding-top: 29.6vh;
    }
    &-time {
