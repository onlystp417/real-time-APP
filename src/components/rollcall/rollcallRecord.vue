<template>
  <div class="rollcall-record">
    <h2 class="record-title">點名紀錄</h2>
    <ul>
      <li>
        <time>2020/01/05 13:00</time>
        <span class="record-ontime">準時</span>
      </li>
      <li>
      ...
      <li>
        ...
        <span class="record-late">遲到</span>
      </li>
      <li>
    ...
    <div class="record-button">
      <buttonQuinary @click="$emit('setTimer', {componentId: 'rollcallHome', missionTimeData:{ level:1, section:2, setTime: 'end'}})">確認</buttonQuinary>
    </div>
  </div>
</template>
